...
def is_mel(name, email):
    ...
    >>> is_mel("Mel Melitpolski", "personal@email.com")
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'cupcake'}, {'type': 'fruit'}, {'type': 'fruit'}, {'type': 'cupcake'}, {'type': 'drink'}])
    ('cupcake', 'drink')

    >>> most_and_least_common_type([{"type": "drink"},{"type": "drink"},{"type": "drink"}])
    ('drink', 'drink')
